...
export default function FormAtualizacaoPiloto(){
    ...
    const getFetchData =async () => {
        try {
            const response = await fetch(`https://slug-liberal-wallaby.ngrok-free.app/piloto/${userId}`)
    ...
    const onSubmit = async (data: any) => {
        ...
        try {
            const response = await fetch(`https://slug-liberal-wallaby.ngrok-free.app/piloto/atualizar/${userId}`, {
            method: 'PUT',
            headers: {
